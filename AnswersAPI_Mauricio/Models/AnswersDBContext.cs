...
namespace AnswersAPI_Mauricio.Models
{
    public partial class AnswersDBContext : DbContext
    {
        ...
        public virtual DbSet<PruebaChat> PruebaChats { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("SERVER=.;DATABASE=AnswersDB;User Id=AnswersUser;Password=1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<General>(entity =>
            {
                entity.HasKey(e => e.Idconfig)
                    .HasName("PK__General__3E2AEF2AD9581EDC");
            ...
            modelBuilder.Entity<PruebaChat>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("PruebaChat");
