...
namespace AnswersAPI_Mauricio.Controllers
{
    ...
    [ApiController]
    public class AskStatusesController : ControllerBase
    {
        private readonly AnswersDBContext _context;

        public AskStatusesController(AnswersDBContext context)
        {
            _context = context;
        }
